-- KNEEBOARD/indicator/init.lua
-- Override: removes the flight plan overview page (ccKneeboard map page).
-- Two changes from the original:
--   pages = {}  (was {{BASE,MAP,OVERLAY}})
--   Add_Map_Page call removed
...
-- DISABLED: was pages = {{BASE,MAP,OVERLAY}} + Add_Map_Page call
pages = {}
		...
		if file ~= "." and
		   ...
		   if attr.mode ~= "directory" then
			  ...
			  elseif '.dds' == ext or
			         ...
			         '.png' == ext or
			         '.tga' == ext then
				  custom_images[#custom_images + 1]  = fn
				  number_of_additional_pages          = number_of_additional_pages + 1
			  end
		   end
		end
